...
import { Reveal, RevealSection } from '@/components/MotionScroll';
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="relative bg-cover text-white py-12 h-[35vh]" style={{ backgroundImage: "url('/ngo-boy.jpg')" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10 flex flex-col justify-center items-center h-full">
          <h1 className="text-4xl md:text-5xl font-bold">Report a Case</h1>
      ...
      {/* Hero */}
      <RevealSection variant="up" className="relative bg-[#0f172a] text-white py-24">
      ...
      <Reveal variant="up" className="bg-[#0f172a] py-16 text-white">
